...
Ylogist=Y;
X=merged_data{:,[2:1460, 1511:1761]}; % check if these are the proteins still on merged_data
protein_ids=merged_data.Properties.VariableNames([2:1460, 1511:1761]);
...
%% saving
save pro_met_elnet_schwarz.mat
