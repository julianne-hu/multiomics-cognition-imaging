...
clear x; for i=1:length(X(1,:)); mdl = fitlm(table(delta_time, sex, site, X(:,i)) ); x(:,i)=mdl.Residuals.Raw;end
clear y; for i=1:length(Y(1,:)); mdl = fitlm(table(delta_time, sex, site, motion, icv, Y(:,i))); y(:,i)=mdl.Residuals.Raw;end
Y=y;
